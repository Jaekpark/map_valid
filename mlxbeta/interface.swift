...
@_cdecl("mlx_do_key_autorepeatoff_beta")
...
@_cdecl("mlx_do_key_autorepeaton_beta")
...
@_cdecl("mlx_get_color_value_beta")
...
@_cdecl("mlx_put_image_to_window_beta")
...
@_cdecl("mlx_destroy_window_beta")
